...
export const CodexSetupBindingSchema = z.object({ profileId: z.string(), codexHome: z.string(), extraSkillRoots: z.array(z.string()), overrides: z.object({ model: z.string().nullable().optional(), provider: z.string().nullable().optional(), reasoning: z.string().nullable().optional(), approvalPolicy: z.string().nullable().optional(), sandbox: z.string().nullable().optional() }), fingerprint: z.string(), appliedAt: z.number() });
