...
export const CodexSetupRefreshSchema = z.object({ changed: z.boolean(), previousFingerprint: z.string(), binding: CodexSetupBindingSchema, scan: CodexSetupScanSchema });
