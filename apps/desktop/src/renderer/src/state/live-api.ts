...
export const liveApi = (): Api => ({
  ...
  codexSetupScan: (input) => rpc().call("codexSetup.scan", { ...input, extraSkillRoots: input.extraSkillRoots ?? [] }),
  codexSetupApply: (input) => rpc().call("codexSetup.apply", { ...input, scan: { ...input.scan, extraSkillRoots: input.scan.extraSkillRoots ?? [] } }),
  codexSetupRollback: (profileId, receiptId) => rpc().call("codexSetup.rollback", { profileId, receiptId }),
  codexSetupGetBinding: (profileId) => rpc().call("codexSetup.getBinding", { profileId }),
  codexSetupRefresh: (profileId, cwd) => rpc().call("codexSetup.refresh", { profileId, cwd }),
  codexSetupDisconnect: (profileId, receiptId) => rpc().call("codexSetup.disconnect", { profileId, receiptId }),
